...
if len(names) > 0:
    ...
    print("<h1>RSVP</h1>")
    print("Enter the names of the people from your invite who are able to attend drinks and dancing in the evening.<br><br>")
    print("<form method='post'>")
    print("<table>")
    print("<tr><td><b>Guest 1</b></td><td><input type='text' name='name1'/></td></tr>")
    print("<tr><td><b>Guest 2</b></td><td><input type='text' name='name2'/></td></tr>")
    print("</table>")
